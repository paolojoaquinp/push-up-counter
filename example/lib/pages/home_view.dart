...
import 'package:body_detection_example/pages/camera_detection_view.dart';
import 'package:body_detection_example/pages/image_detection_view.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  Widget? get _selectedTab => _selectedTabIndex == 0
      ? ImageDetectionView(
          ...
          detectImagePose: _detectImagePose,
          detectImageBodyMask: _detectImageBodyMask,
      ...
      : _selectedTabIndex == 1
          ? CameraDetectionView(
              ...
              maskImage: _maskImage,
              imageSize: _imageSize,
              isDetectingPose: _isDetectingPose,
              toggleDetectPose: _toggleDetectPose,
              toggleDetectBodyMask: _toggleDetectBodyMask,
              isDetectingBodyMask: _isDetectingBodyMask
            )
          : null;
